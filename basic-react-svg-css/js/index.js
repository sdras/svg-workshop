  ...
  render: function render() {
    return React.createElement(
      ...
      React.createElement(
        "div",
        { className: "switcher" },
        React.createElement(IconOffice, { iconTitle: "animatedOffice" })
      ),
      React.createElement(IconOffice, { iconTitle: "orangeBook", bookfill: "orange", bookside: "#39B39B", bookfront: "#76CEBD" }),
      React.createElement(IconOffice, { iconTitle: "biggerOffice", width: "200", height: "200" })
    );
  }
});

// Icon
var IconOffice = React.createClass({
  ...
  render: function render() {
    return React.createElement(
      "svg",
      { className: "office", xmlns: "http://www.w3.org/2000/svg", width: this.props.width, height: this.props.height, viewBox: "0 0 188.5 188.5", "aria-labelledby": this.props.iconTitle },
      React.createElement(
        "title",
        { id: this.props.iconTitle },
        "Office With a Lamp"
      ),
      React.createElement(
        "g",
        ...
        React.createElement("path", { fill: this.props.bookside, d: "M50.3 77.5h10.4v57.18H50.3z" }),
        React.createElement("path", { fill: this.props.bookfront, d: "M60.7 77.5h38.9v57.19H60.7z" }),
        ...
        React.createElement(
          ...
          React.createElement("path", { fill: this.props.bookfill, d: "M28.4 105h58.5v12.95H28.4z" }),
